...
public class ExamBean implements Serializable {
     ...
     * @return
     *      a list of {@link Exam}s
     * @throws SQLException
     * @throws ClassNotFoundException
     */
    public List<Exam> getExamList() throws SQLException, ClassNotFoundException {
     ...
     * @throws ClassNotFoundException
     */
    public List<Integer> getExamIds() throws SQLException, ClassNotFoundException {
     ...
     * @throws ClassNotFoundException
     */
    public void saveExam(Exam exam, Time time) throws SQLException, ClassNotFoundException {
